        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              _buildContactCard(Icons.email, "Email Us",
                  "contact@outfitmaven.com", "mailto:contact@outfitmaven.com"),
              const SizedBox(height: 10),
              _buildContactCard(
                  Icons.phone, "Call Us", "+123 456 7890", "tel:+1234567890"),
              const SizedBox(height: 20),
              Center(
                child: Text(
